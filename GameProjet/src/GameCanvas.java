...
public class GameCanvas extends JPanel implements Runnable, KeyListener, ComponentListener {
	...
	//그래픽스 함수를 사용하기 위한 클래스
		...
		//private Attack attack; // 공격 클래스
		private List<Attack> attacks = new ArrayList<>(); // 공격 클래스 목록

		int x = 100, y = 100, sel = 1; // 캐릭터의 초기 위치와 선택 상태
		...
		public GameCanvas(){
		    ...
		    background = Toolkit.getDefaultToolkit().getImage("rsc/map.png");
		}
		...
		public void paint(Graphics g) {
		    ...
		    g.drawImage(background, 0, 0, getWidth(), getHeight(), this); // 배경 이미지 그리기
